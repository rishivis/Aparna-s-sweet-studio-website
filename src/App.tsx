...
<div className="min-h-screen bg-brand-cream-light text-brand-tertiary flex flex-col font-sans selection:bg-brand-accent selection:text-brand-secondary scroll-smooth overflow-x-hidden">
      ...
      <button
        type="button"
        onClick={toggleMusic}
        className="fixed bottom-5 right-5 z-[9999] w-12 h-12 rounded-full bg-brand-secondary text-white shadow-lg flex items-center justify-center text-xl transition-transform hover:scale-110"
